...
@section('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Data_collected th');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Data_collected');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Data_collected', JSON.stringify(selectedColumns));
        }
